...
**威宏（William Wei）^1,2^，刘岚岚^3^**

（1. 利兹大学 工程与物理科学学部 计算机科学学院，英国 利兹；2. 空间计算（福建）科技有限公司，福建 福州；3. 福建师范大学 公共管理学院，福建 福州）
...
**数据与代码：** 全部输入为公开数据，来源、版本、校验值与许可见英文稿补充材料；代码、审计与验证记录已公开于 https://github.com/william19307/ai-grid-flexibility-research，并存档于 Zenodo（DOI: 10.5281/zenodo.22804057）。

**利益冲突：** 作者声明无利益冲突。

**作者简介：** 威宏（1999—），男，英国利兹大学人工智能专业硕士研究生，研究方向为算力负荷与电力系统协同、能源系统建模，qkfp0742@leeds.ac.uk；刘岚岚（1998—），女，福建师范大学公共管理专业硕士研究生，研究方向为能源政策与公共治理。
