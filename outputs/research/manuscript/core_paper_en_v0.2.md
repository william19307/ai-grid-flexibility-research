...
**Working English draft v0.2 (2026-09-15). Structure follows a Nature Energy Article. Every bracketed item `[PENDING: ...]` marks a result that does not yet exist; no number in this file may be cited until the corresponding evidence tier in `论文工作稿` is "regional result" or higher.**
